...
globalkeys = gears.table.join(
    ...
    awful.key({modkey},"p" ,
        ...
        {description = "lauch rofi application laucher", group="rofi"}
    ),
    ...
    awful.key({modkey},"r" ,
        ...
        {description = "lauch rofi command laucher", group="rofi"}
    ),
    ...
    awful.key({},  "XF86AudioLowerVolume",
        function()
            os.execute(string.format("amixer set %s 5%%-", widgets.vol_control.channel))
            naughty.notify({
                title = "Volume",
                text = "volume decresed",
